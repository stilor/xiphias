...
static const testcase_t testcases[] = {
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            E(MESSAGE,
                    .loc = LOC("simple-no-decl.xml", 1, 1),
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            E(MESSAGE,
                    .loc = LOC("simple-invalid-encoding.xml", 1, 153),
                    .info = XMLERR(ERROR, XML, ENCODING_ERROR),
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            E(MESSAGE,
                    .loc = LOC("truncated-decl1.xml", 1, 21),
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            E(MESSAGE,
                    .loc = LOC("truncated-decl2.xml", 1, 30),
                    .info = XMLERR(ERROR, XML, P_XMLDecl),
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            E(MESSAGE,
                    .loc = LOC("truncated-decl3.xml", 1, 37),
                    .info = XMLERR(ERROR, XML, P_XMLDecl),
                    .msg = "Malformed XMLDecl",
            ),
            END,
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            E(MESSAGE,
                    .loc = LOC("decl-no-version1.xml", 1, 7),
                    .info = XMLERR(ERROR, XML, P_XMLDecl),
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            E(MESSAGE,
                    .loc = LOC("decl-no-version2.xml", 1, 7),
                    .info = XMLERR(ERROR, XML, P_XMLDecl),
                    .msg = "Mandatory pseudo-attribute 'version' missing in XMLDecl",
            ),
            E(XMLDECL,
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            E(MESSAGE,
                    .loc = LOC("decl-wrong-order.xml", 1, 7),
                    .info = XMLERR(ERROR, XML, P_XMLDecl),
                    .msg = "Mandatory pseudo-attribute 'version' missing in XMLDecl",
            ),
            E(MESSAGE,
                    .loc = LOC("decl-wrong-order.xml", 1, 24),
                    .info = XMLERR(ERROR, XML, P_XMLDecl),
                    .msg = "Unexpected pseudo-attribute",
            ),
            E(XMLDECL,
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            E(MESSAGE,
                    .loc = LOC("decl-malformed1.xml", 1, 19),
                    .info = XMLERR(ERROR, XML, P_XMLDecl),
                    .msg = "Malformed XMLDecl",
            ),
            END,
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            E(MESSAGE,
                    .loc = LOC("decl-invalid-encoding.xml", 1, 30),
                    .info = XMLERR(ERROR, XML, P_XMLDecl),
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            E(MESSAGE,
                    .loc = LOC("decl-invalid-standalone.xml", 1, 32),
                    .info = XMLERR(ERROR, XML, P_XMLDecl),
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(MESSAGE,
                    .loc = LOC("invalid-top-level-nodecl.xml", 1, 1),
                    .info = XMLERR(ERROR, XML, P_document),
                    .msg = "Invalid content at root level",
            ),
            E(MESSAGE,
                    .loc = LOC("invalid-top-level-nodecl.xml", 1, 4),
                    .info = XMLERR(ERROR, XML, P_document),
                    .msg = "No root element",
            ),
            END,
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(MESSAGE,
                    .loc = LOC("invalid-top-level.xml", 2, 1),
                    .info = XMLERR(ERROR, XML, P_document),
                    .msg = "Invalid content at root level",
            ),
            E(MESSAGE,
                    .loc = LOC("invalid-top-level.xml", 2, 13),
                    .info = XMLERR(ERROR, XML, P_document),
                    .msg = "No root element",
            ),
            END,
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(MESSAGE,
                    .loc = LOC("invalid-top-level-withroot.xml", 2, 1),
                    .info = XMLERR(ERROR, XML, P_document),
                    .msg = "Invalid content at root level",
            ),
            E_XMLDECL_A,
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E_XMLDECL_A,
            E(MESSAGE,
                    .loc = LOC("dtd-after-element.xml", 2, 1),
                    .info = XMLERR(ERROR, XML, P_document),
                    .msg = "Document type definition not allowed here",
            ),
            END,
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E_XMLDECL_A,
            E(MESSAGE,
                    .loc = LOC("root-element-twice.xml", 2, 1),
                    .info = XMLERR(ERROR, XML, P_document),
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(MESSAGE,
                    .loc = LOC("no-root-element.xml", 4, 1),
                    .info = XMLERR(ERROR, XML, P_document),
                    .msg = "No root element",
            ),
            END,
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(MESSAGE,
                    .loc = LOC("bad-emptytag-name.xml", 1, 2),
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(MESSAGE,
                    .loc = LOC("truncated-stag.xml", 2, 1),
                    .info = XMLERR(ERROR, XML, P_STag),
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(MESSAGE,
                    .loc = LOC("stag-badchar2.xml", 1, 10),
                    .info = XMLERR(ERROR, XML, P_STag),
                    .msg = "Expect whitespace, or >, or />",
            ),
            END,
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(MESSAGE,
                    .loc = LOC("etag-missing-bracket.xml", 2, 1),
                    .info = XMLERR(ERROR, XML, P_ETag),
                    .msg = "Expected string: '>'",
            ),
            END,
