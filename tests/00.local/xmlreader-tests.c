...
static const testcase_t testcases_structure[] = {
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(MESSAGE, LOC("invalid-top-level-nodecl.xml", XMLERR_EOF, XMLERR_EOF),
                    .info = XMLERR(ERROR, XML, P_document),
                    .msg = "No root element",
            ),
            END,
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(MESSAGE, LOC("invalid-top-level.xml", XMLERR_EOF, XMLERR_EOF),
                    .info = XMLERR(ERROR, XML, P_document),
                    .msg = "No root element",
            ),
            END,
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(MESSAGE, LOC("no-root-element.xml", XMLERR_EOF, XMLERR_EOF),
                    .info = XMLERR(ERROR, XML, P_document),
                    .msg = "No root element",
            ),
            END,
    ...
    {
        .desc = "Attributes with char/entity references",
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(UNKNOWN_ENTITY, LOC("attribute-with-references.xml", 1, 44),
    ...
    {
        .desc = "Attributes with invalid references",
