...
static const testcase_t testcases_structure[] = {
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(STAG, LOC("comments-pis-torture.xml", 4, 1),
                    .type = U"a",
                    .typelen = 1,
            ),
            E(STAG_END, LOC("comments-pis-torture.xml", 4, 3),
                    .is_empty = false,
            ),
            E(COMMENT, LOC("comments-pis-torture.xml", 5, 9),
                    .content = U"<!",
                    .contentlen = 2,
            ),
            E(COMMENT, LOC("comments-pis-torture.xml", 7, 9),
                    .content = U"*-*-*-*",
                    .contentlen = 7,
            ),
            ...
            E(ETAG, LOC("comments-pis-torture.xml", 10, 1),
                    .type = U"a",
                    .typelen = 1,
            ),
            END,
