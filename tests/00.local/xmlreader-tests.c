...
static const testcase_t testcases_encoding[] = {
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(MESSAGE, LOC("simple-invalid-encoding.xml", 1, 154),
                    NOTOK,
                    .info = XMLERR(ERROR, XML, ENCODING_ERROR),
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(MESSAGE, LOC("simple-utf16.xml", 1, 40),
                    NOTOK,
                    .info = XMLERR(ERROR, XML, ENCODING_ERROR),
...
static const testcase_t testcases_structure[] = {
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(DTD_END, LOC("dtd-twice.xml", 1, 13),
                    NOTOK,
            ),
            ...
            E(DTD_END, LOC("dtd-twice.xml", 2, 13),
                    NOTOK,
            ),
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(DTD_END, LOC("dtd-after-element.xml", 2, 13),
                    NOTOK,
            ),
            END,
        },
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(APPEND, LOC("attribute-with-references.xml", 1, 38),
                    TOK("\""),
                    .ws = false,
            ),
            ...
            E(APPEND, LOC("attribute-with-references.xml", 1, 48),
                    TOK("\xD0\xAE"),
                    .ws = false,
            ),
            ...
            E(APPEND, LOC("attribute-with-references.xml", 1, 56),
                    TOK("\xD1\x8A"),
                    .ws = false,
            ),
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(APPEND, LOC("attribute-restricted-references.xml", 2, 7),
                    TOK("\x01"),
                    .ws = false,
            ),
            E(APPEND, LOC("attribute-restricted-references.xml", 2, 11),
                    TOK("\x1F"),
                    .ws = false,
            ),
            E(APPEND, LOC("attribute-restricted-references.xml", 2, 17),
                    TOK("\x7F"),
                    .ws = false,
            ),
            E(APPEND, LOC("attribute-restricted-references.xml", 2, 23),
                    TOK("\xC2\x80"),
                    .ws = false,
            ),
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(APPEND, LOC("chardata-entities.xml", 1, 51),
                    TOK("a"),
                    .ws = false,
            ),
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(DTD_END, LOC("dtd-no-subset.xml", 1, 13),
                    NOTOK,
            ),
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(DTD_END, LOC("dtd-ext-system.xml", 1, 33),
                    NOTOK,
            ),
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(DTD_END, LOC("dtd-ext-public.xml", 1, 58),
                    NOTOK,
            ),
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(DTD_END, LOC("dtd-int-empty.xml", 1, 16),
                    NOTOK,
            ),
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(DTD_END, LOC("entities01.xml", 4, 3),
                    NOTOK,
            ),
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(APPEND, LOC("entities02.xml", 2, 15),
                    TOK("\""),
                    .ws = false,
            ),
            ...
            E(DTD_END, LOC("entities02.xml", 6, 3),
                    NOTOK,
            ),
