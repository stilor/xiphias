...
static const testcase_t testcases_xmldecl[] = {
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(APPEND,
                LOC("whitespace-cr.xml", 4, 18),
                TOK("\r"),
                .ws = false,
            ),
            E(APPEND,
                LOC("whitespace-cr.xml", 4, 23),
                TOK("b='c'/>"),
                .ws = false,
            ),
            E(ENTITY_DEF_END,
...
static const testcase_t testcases_structure[] = {
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(APPEND,
                    LOC("attribute-with-references.xml", 1, 12),
                    TOK("y"),
                    .ws = false,
            ),
            E(ENTITY_START,
            ...
            E(APPEND,
                    LOC("attribute-with-references.xml", 1, 19),
                    TOK("x"),
                    .ws = false,
            ),
            E(ENTITY_START,
            ...
            E(APPEND,
                    LOC("attribute-with-references.xml", 1, 25),
                    TOK("w"),
                    .ws = false,
            ),
            E(ENTITY_START,
            ...
            E(APPEND,
                    LOC("attribute-with-references.xml", 1, 30),
                    TOK("v"),
                    .ws = false,
            ),
            E(ENTITY_START,
            ...
            E(APPEND,
                    LOC("attribute-with-references.xml", 1, 37),
                    TOK("u"),
                    .ws = false,
            ),
            E(APPEND,
                    LOC("attribute-with-references.xml", 1, 38),
                    TOK("\""),
                    .ws = false,
            ),
            E(APPEND,
                    LOC("attribute-with-references.xml", 1, 43),
                    TOK("c"),
                    .ws = false,
            ),
            E(ENTITY_UNKNOWN,
            ...
            E(APPEND,
                    LOC("attribute-with-references.xml", 1, 47),
                    TOK("e"),
                    .ws = false,
            ),
            E(APPEND,
                    LOC("attribute-with-references.xml", 1, 48),
                    TOK("\xD0\xAE"),
                    .ws = false,
            ),
            E(APPEND,
                    LOC("attribute-with-references.xml", 1, 55),
                    TOK("g"),
                    .ws = false,
            ),
            E(APPEND,
                    LOC("attribute-with-references.xml", 1, 56),
                    TOK("\xD1\x8A"),
                    .ws = false,
            ),
            E(APPEND,
                    LOC("attribute-with-references.xml", 1, 63),
                    TOK("h"),
                    .ws = false,
            ),
            E(STAG_END,
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(APPEND,
                    LOC("attribute-invalid-references1.xml", 2, 60),
                    TOK(";"),
                    .ws = false,
            ),
            E(MESSAGE,
            ...
            E(APPEND,
                    LOC("attribute-invalid-references1.xml", 2, 63),
                    TOK(";"),
                    .ws = false,
            ),
            E(MESSAGE,
            ...
            E(APPEND,
                    LOC("attribute-invalid-references1.xml", 2, 67),
                    TOK(";"),
                    .ws = false,
            ),
            E(MESSAGE,
            ...
            E(APPEND,
                    LOC("attribute-invalid-references1.xml", 2, 71),
                    TOK("!"),
                    .ws = false,
            ),
            E(MESSAGE,
            ...
            E(APPEND,
                    LOC("attribute-invalid-references1.xml", 2, 74),
                    TOK("^"),
                    .ws = false,
            ),
            E(MESSAGE,
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(APPEND,
                    LOC("attribute-restricted-references.xml", 2, 7),
                    TOK("\x01"),
                    .ws = false,
            ),
            E(APPEND,
                    LOC("attribute-restricted-references.xml", 2, 11),
                    TOK("\x1F"),
                    .ws = false,
            ),
            E(APPEND,
                    LOC("attribute-restricted-references.xml", 2, 17),
                    TOK("\x7F"),
                    .ws = false,
            ),
            E(APPEND,
                    LOC("attribute-restricted-references.xml", 2, 23),
                    TOK("\xC2\x80"),
                    .ws = false,
            ),
            E(STAG_END,
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(APPEND,
                    LOC("chardata-entities.xml", 1, 32),
                    TOK(" entities "),
                    .ws = false,
            ),
            E(ENTITY_START,
            ...
            E(APPEND,
                    LOC("chardata-entities.xml", 1, 46),
                    TOK(" and "),
                    .ws = false,
            ),
            E(APPEND,
                    LOC("chardata-entities.xml", 1, 51),
                    TOK("a"),
                    .ws = false,
            ),
            E(APPEND,
                    LOC("chardata-entities.xml", 1, 57),
                    TOK(" "),
                    .ws = false,
            ),
            E(ENTITY_UNKNOWN,
            ...
            E(APPEND,
                    LOC("chardata-entities.xml", 1, 66),
                    TOK(" entity."),
                    .ws = false,
            ),
            E(ETAG,
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(APPEND,
                    LOC("entities02.xml", 2, 15),
                    TOK("\""),
                    .ws = false,
            ),
            E(APPEND,
                    LOC("entities02.xml", 2, 21),
                    TOK(">"),
                    .ws = false,
            ),
            E(ENTITY_DEF_END,
            ...
            E(APPEND,
                    LOC("entities02.xml", 3, 15),
                    TOK("&quot;"),
                    .ws = false,
            ),
            E(APPEND,
                    LOC("entities02.xml", 3, 21),
                    TOK(">"),
                    .ws = false,
            ),
            E(ENTITY_DEF_END,
            ...
            E(APPEND,
                    LOC("entities02.xml", 4, 17),
                    TOK("&bar;"),
                    .ws = false,
            ),
            E(APPEND,
                    LOC("entities02.xml", 4, 22),
                    TOK("b"),
                    .ws = false,
            ),
            E(ENTITY_DEF_END,
            ...
            E(APPEND,
                    LOC("entities02.xml", 5, 17),
                    TOK("&baz;"),
                    .ws = false,
            ),
            E(APPEND,
                    LOC("entities02.xml", 5, 22),
                    TOK("b"),
                    .ws = false,
            ),
            E(ENTITY_DEF_END,
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(APPEND,
                LOC("entity-bad1.xml", 9, 15),
                TOK("&"),
                .ws = false,
            ),
            E(APPEND,
                LOC("entity-bad1.xml", 9, 20),
                TOK("#38;"),
                .ws = false,
            ),
            E(ENTITY_DEF_END,
            ...
            E(APPEND,
                LOC("entity-bad1.xml", 10, 15),
                TOK("&"),
                .ws = false,
            ),
            E(APPEND,
                LOC("entity-bad1.xml", 10, 20),
                TOK("#38;"),
                .ws = false,
            ),
            E(ENTITY_DEF_END,
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(APPEND,
                LOC("entity-bad2.xml", 2, 16),
                TOK("&"),
                .ws = false,
            ),
            E(APPEND,
                LOC("entity-bad2.xml", 2, 21),
                TOK("b; aa"),
                .ws = false,
            ),
            E(ENTITY_DEF_END,
            ...
            E(APPEND,
                LOC("entity-bad2.xml", 3, 16),
                TOK("&"),
                .ws = false,
            ),
            E(APPEND,
                LOC("entity-bad2.xml", 3, 21),
                TOK("c; bb"),
                .ws = false,
            ),
            E(ENTITY_DEF_END,
            ...
            E(APPEND,
                LOC("entity-bad2.xml", 4, 16),
                TOK("&"),
                .ws = false,
            ),
            E(APPEND,
                LOC("entity-bad2.xml", 4, 21),
                TOK("a; cc"),
                .ws = false,
            ),
            E(ENTITY_DEF_END,
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(APPEND,
                LOC("entity-bad3.xml", 2, 16),
                TOK("&b;"),
                .ws = false,
            ),
            E(APPEND,
                LOC("entity-bad3.xml", 2, 19),
                TOK(" aa"),
                .ws = false,
            ),
            E(ENTITY_DEF_END,
            ...
            E(APPEND,
                LOC("entity-bad3.xml", 3, 16),
                TOK("&c;"),
                .ws = false,
            ),
            E(APPEND,
                LOC("entity-bad3.xml", 3, 19),
                TOK(" bb"),
                .ws = false,
            ),
            E(ENTITY_DEF_END,
            ...
            E(APPEND,
                LOC("entity-bad3.xml", 4, 16),
                TOK("&a;"),
                .ws = false,
            ),
            E(APPEND,
                LOC("entity-bad3.xml", 4, 19),
                TOK(" cc"),
                .ws = false,
            ),
            E(ENTITY_DEF_END,
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(APPEND,
                LOC("entity-bad4.xml", 4, 15),
                TOK("&"),
                .ws = false,
            ),
            E(APPEND,
                LOC("entity-bad4.xml", 4, 21),
                TOK("x"),
                .ws = false,
            ),
            E(MESSAGE,
