...
#define E_XMLDECL_A(s, l, p) \
        ...
        E(STAG_END, NOLOC, NOTOK, .is_empty = true) \
...
static const testcase_t testcases_encoding[] = {
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(MESSAGE, LOC("simple-utf16.xml", 1, 38),
                    NOTOK,
                    .info = XMLERR(ERROR, XML, ENCODING_ERROR),
...
static const testcase_t testcases_structure[] = {
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(MESSAGE, LOC("attribute-invalid-references1.xml", 2, 16),
                    NOTOK,
                    .info = XMLERR(ERROR, XML, P_CharRef),
                    .msg = "Character reference did not evaluate to "
                    "a valid UCS-4 code point",
            ),
            E(MESSAGE, LOC("attribute-invalid-references1.xml", 2, 29),
                    NOTOK,
                    .info = XMLERR(ERROR, XML, P_CharRef),
                    .msg = "Character reference did not evaluate to "
                    "a valid UCS-4 code point",
            ),
            E(MESSAGE, LOC("attribute-invalid-references1.xml", 2, 34),
                    NOTOK,
                    .info = XMLERR(ERROR, XML, P_CharRef),
                    .msg = "Referenced character does not match Char production",
            ),
            E(MESSAGE, LOC("attribute-invalid-references1.xml", 2, 42),
                    NOTOK,
                    .info = XMLERR(ERROR, XML, P_CharRef),
                    .msg = "Referenced character does not match Char production",
            ),
            E(MESSAGE, LOC("attribute-invalid-references1.xml", 2, 50),
                    NOTOK,
                    .info = XMLERR(ERROR, XML, P_CharRef),
                    .msg = "Referenced character does not match Char production",
            ),
            E(MESSAGE, LOC("attribute-invalid-references1.xml", 2, 58),
                    NOTOK,
                    .info = XMLERR(ERROR, XML, P_CharRef),
                    .msg = "Referenced character does not match Char production",
            ),
            E(MESSAGE, LOC("attribute-invalid-references1.xml", 2, 60),
                    NOTOK,
            ...
            E(MESSAGE, LOC("attribute-invalid-references1.xml", 2, 63),
                    NOTOK,
                    .info = XMLERR(ERROR, XML, P_CharRef),
            ...
            E(MESSAGE, LOC("attribute-invalid-references1.xml", 2, 67),
                    NOTOK,
                    .info = XMLERR(ERROR, XML, P_CharRef),
                    .msg = "Malformed character reference",
            ),
            ...
            E(MESSAGE, LOC("attribute-invalid-references1.xml", 2, 71),
                    NOTOK,
                    .info = XMLERR(ERROR, XML, P_CharRef),
                    .msg = "Malformed character reference",
            ),
            ...
            E(MESSAGE, LOC("attribute-invalid-references1.xml", 2, 74),
                    NOTOK,
            ...
            E(MESSAGE, LOC("attribute-invalid-references1.xml", 2, 81),
                    NOTOK,
                    .info = XMLERR(ERROR, XML, P_CharRef),
                    .msg = "Referenced character does not match Char production",
            ),
