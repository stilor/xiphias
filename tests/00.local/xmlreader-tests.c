...
static const testcase_t testcases_structure[] = {
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(DTD_END, LOC("entities01.xml", 1, 1),
                    NOTOK,
            ),
            ...
            E(ENTITY_END, LOC("entities01.xml", 5, 9),
                    TOK("foo"),
                    .type = XML_READER_REF_INTERNAL,
            ),
    ...
    },
    {
        ...
        .events = (const xml_reader_cbparam_t[]){
            ...
            E(DTD_END, LOC("entities02.xml", 1, 1),
                    NOTOK,
            ),
            ...
            E(ENTITY_END, LOC("entity(foo1)", 1, 7),
                    TOK("bar"),
                    .type = XML_READER_REF_INTERNAL,
            ),
            E(APPEND, LOC("entity(bar)", 1, 1),
            ...
            E(ENTITY_END, LOC("entities02.xml", 7, 17),
                    TOK("foo1"),
                    .type = XML_READER_REF_INTERNAL,
            ),
            ...
            E(ENTITY_END, LOC("entity(baz)", 1, 7),
                    TOK("quot"),
                    .type = XML_READER_REF_INTERNAL,
            ),
            E(APPEND, LOC("entity(quot)", 1, 1),
            ...
            E(ENTITY_END, LOC("entity(foo2)", 1, 7),
                    TOK("baz"),
                    .type = XML_READER_REF_INTERNAL,
            ),
            ...
            E(ENTITY_END, LOC("entities02.xml", 7, 32),
                    TOK("foo2"),
                    .type = XML_READER_REF_INTERNAL,
            ),
